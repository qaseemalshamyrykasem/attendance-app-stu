            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: _getStatusColor().withValues(alpha: 25.5),
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    fontSize: 16,
                    color: _getStatusColor().withValues(alpha: 229.5),
                    fontFamily: 'Cairo',
                  ),
                  textAlign: TextAlign.center,
                ),
    ...
    switch (status.toLowerCase()) {
      case 'success':
        return Container(
          ...
          height: 120,
          decoration: BoxDecoration(
            color: AppColors.attendanceSuccess.withValues(alpha: 25.5),
      ...
      case 'duplicate':
        return Container(
          ...
          height: 120,
          decoration: BoxDecoration(
            color: AppColors.attendanceDuplicate.withValues(alpha: 25.5),
            shape: BoxShape.circle,
          ),
          child: const Icon(
      ...
      case 'closed':
        return Container(
          ...
          height: 120,
          decoration: BoxDecoration(
            color: AppColors.attendanceClosed.withValues(alpha: 25.5),
            shape: BoxShape.circle,
          ),
          child: const Icon(
      ...
      case 'error':
        return Container(
          ...
          height: 120,
          decoration: BoxDecoration(
            color: AppColors.attendanceError.withValues(alpha: 25.5),
            shape: BoxShape.circle,
          ),
          child: const Icon(
            Icons.error_rounded,
      ...
      default:
        return Container(
          ...
          height: 120,
          decoration: BoxDecoration(
            color: AppColors.attendancePending.withValues(alpha: 25.5),
            shape: BoxShape.circle,
          ),
          child: SizedBox(
            width: 80,
